...
Il montre une situation dans laquelle **deux personnes prennent des décisions séparément**, et où le meilleur choix pour chacun individuellement peut conduire à un résultat moins avantageux pour les deux.
...
- **Si B avoue et A garde le silence** : B est libéré et A reçoit **5 ans**.
- **Si les deux avouent** : chacun reçoit **3 ans de prison**.
...
`B` fait exactement le même raisonnement.
