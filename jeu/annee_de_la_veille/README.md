...
Dans ce jeu, le mot **« veille »** porte un double sens. D’une part, il désigne **le jour précédent**, celui où des humains ont pris quelque chose d’essentiel à la communauté. D’autre part, la **veille** évoque l’état de vigilance, de garde ou de surveillance dans lequel la communauté est désormais plongée. Pendant toute l’année qui suit, ses membres vivent dans l’attente du retour annoncé, observant les signes du changement, se préparant à l’échéance et cherchant à préserver leur avenir malgré la menace. Ainsi, *L’année de la veille* est à la fois l’année qui suit **la veille du drame** et l’année passée **en état de veille**, dans l’attente inquiète de ce qui reviendra.

## Qui nous sommes

Nous avons tous deux rôles à jouer dans ce jeu. Nous sommes invités à naviguer constamment entre ces deux rôles.

- Le premier consiste à prendre la parole au nom des membres de cette communauté et à nous soucier de leur destinée, tant individuelle que collective.
- Le second consiste à introduire, avec détachement, des dilemmes et des situations difficiles afin de voir ce qu’elles produisent.

Le jeu nous demandera de nous exprimer au nom de différents résidents de la communauté et d’agir pour eux. Chaque fois que nous le ferons, nous indiquerons clairement quel résident parle ou agit.
...
Le jeu débute le lendemain d’un évènement traumatisant pour la communauté :
...
Nous inscrivons le nom de notre communauté* en haut, au centre de la feuille.
...
Dessinons les limites psychologiques de la communauté avec une ellipse dont le contour est une mince ligne pointillée effaçable. Prenez initialement environ le tiers de l’espace disponible. Cette limite peut changer pendant le jeu.

Ce qui est à l’intérieur de ce périmètre appartient à la communauté et tout y est considéré comme étant à proximité. Ce qui est à l’extérieur est externe à la communauté et sa distance du périmètre indique son éloignement.
...
Toutes les autres ressources sont écrites dans la case « Pénuries », et les personnes qui les ont déclarées dessinent leur rareté ou leur absence d’une manière ou d’une autre sur la carte.
...
> « Les humains ont volé une pomme de l’arbre magique. »

Ensuite, nous choisissons une personne qui dessinera, à l’extérieur du périmètre de la communauté, un lieu marquant laissé derrière par le voleur. Il peut s’agir d’un campement, d’un tas de déchets, d’un phare, d’une statue ou d’une église de fortune, etc. Il est préférable que ce dessin demeure petit et simple.
...
3. Choisir une action parmi :
   - 3.A Découvrir quelque chose de vieux.
   - 3.B S’entendre sur un point.
   - 3.C Commencer un projet.

### 1. Tirer un évènement

La plupart des évènements comportent deux options parmi lesquelles nous devons choisir, séparées par la conjonction « ou ». La joueuse ou le joueur actif choisit l’option jugée la plus intéressante et adaptée, puis lit le texte à haute voix.
...
Travailler sur les projets consiste à réduire de `1` chaque dé de projet présent sur la carte. Nous sautons cette action si l’évènement tiré précédemment indique de ne pas le faire. 
...
La fin d’un projet doit être ressentie comme un pas en avant, pas comme un pas en arrière. Cela ne signifie que toute la communauté est heureuse du résultat, toutefois.
...
> - Une fosse commune est découverte au nord de la communauté.
> - Une meute de créatures-garous émerge de la forêt.
> - Des récits oubliés de la fin des temps commencent à circuler.
> - Un rite ancien est accompli pour la première fois depuis la visite des humains.
> - Un symbole religieux archaïque apparaît dans le ciel.
> - Il y a un puits à sec situé à la limite de la ville.
> - Il y a une roue à aubes cassée à un kilomètre en amont.
> - D’étranges bruits plaintifs se font entendre dans les collines, la nuit.

### 3.B S’entendre sur un point

Une autre des actions possibles est **S’entendre sur un point**. Elle consiste à ouvrir une discussion en formulant une déclaration sur un problème ou une situation de la communauté. Dans le sens des aiguilles d’une montre, chaque personne a ensuite l’occasion de réagir **une fois**, en exprimant son accord avec la déclaration ou en restant en silence.

S’entendre sur un point ne mène jamais à une décision concrète. Chacun s’exprime (ou se tait), puis la discussion se termine. C’est ainsi que fonctionnent les conversations dans les communautés : beaucoup de choses restent non dites afin de préserver la paix. **Nous sommes encouragés de prendre la parole à travers les membres de la communauté**.

Chaque accord doit être lié à une situation présente sur la carte. **Quand une discussion s’achève, marquez la situation concernée d’un petit point**.


> **Par exemple :  La communauté doit s’entendre sur la manière de punir la boule de lumière nommée Sol pour ne pas avoir averti la communauté des problèmes à la tour du sorcier.**
> - La première personne fait parler Eidoo : « Eidoo dit : “Nous devrions punir Sol en l’enfermant dans la tour.” » 
> - La deuxième personne fait parler Tezog : « Tezog reste silencieux, se gratte l’oreille puis mange ce qu’il en retire, sans intérêt. 
> - La troisième personne dit de sa propre voix : « Oui ! Sol est dangereux. » 
> - La quatrième personne exprime le silence de Sol : « Sol rayonne de tristesse, mais reste silencieux. »

Il est important de rester concis. Si l’un d’entre nous souhaite en dire davantage sur un sujet, nous pouvons toujours utiliser plus tard une action de type **S’entendre sur un point** à nouveau.

> **Quelques exemples de conversations :**
>
> - Est-ce que nous devons riposter à l’attaque des bikers ?
> - Pouvons-nous utiliser le bus scolaire pour faire dormir les enfants du village ?

### 3.C Commencer un projet

La dernière action possible est de **Commencer un nouveau projet**. Nous choisissons un problème et déclarons ce que la communauté va faire pour le résoudre ou pour évoluer.

Il n’y a pas de consultation à ce sujet : la communauté se met simplement au travail. **Nous sommes encouragés à indiquer le ou les membres de la communauté impliqués**.

Nous décidons rapidement ensemble du nombre de semaines nécessaires pour mener le projet à terme (1 au minimum et 6 au maximum).

Nous nous souvenons que nous faisons partie d’une petite communauté. Il n’est ni facile ni rapide de construire une maison ou de réparer une roue à aubes. Avons-nous les outils et les compétences nécessaires ?

Un projet peut nécessiter de ressources. Si une ressource nécessaire est abondante, elle peut devenir une pénurie pour accélérer le projet. Une ressource qui est en pénurie ne peut pas être utilisée.

Si un projet ne peut normalement être mené à bien en moins de six semaines, nous devons le compléter par étapes.

Nous plaçons un dé sur la carte à l’endroit où le projet a lieu, la face supérieure indiquant le nombre de semaines nécessaires à son accomplissement.


> **Quelques exemples de projets :**
>
> - Nous transformons le puits en entrepôt afin de conserver la nourriture au frais.
> - Sol dompte les loups.
> - Le sorcier propose de sacrifier un nouveau-né à la pleine lune pour apaiser les Chuchoteurs.
> - Rothwen et ses vers de boue commencent à démonter les clôtures construites par les humains pour les emprisonner.
> - Anaïk enseigne la langue drakène aux jeunes du village.
> - Sordid guide plusieurs autres personnes dans la restauration des arches runiques.

## Décès

Chaque mort a le potentiel de transformer radicalement la communauté. Lorsqu’une ou un membre meurt, prenons un moment pour réfléchir aux répercussions possibles.
...
En jouant au jeu, nous devons nous abstenir de discussions libres et informelles sur ce que nous devrions faire ensuite. Le jeu prévoit des mécanismes spécifiques pour traiter les problèmes de la communauté et exprimer nos désaccords.

Lorsque nous jouons, nous ne parlons pas hors de notre tour et nous n’essayons pas de contourner ces mécanismes. Ces règles montrent à quel point il est difficile d’impliquer toute une communauté dans une conversation, et comment les tensions et les désaccords peuvent persister pendant des semaines, voire des mois.
...
| 4 | Un outil puissant des humains est trouvé près de la communauté. Comment est-il détruit ? Qu’est-ce que cela vous coûte ? | ou | Quels outils importants et essentiels manquent à la communauté ? |
| 5 | Deux (ou plus) des membres de la communauté vivant ici décident de s’unir. Qui accomplit les rituels de l’union ? | ou | Un jeune personnage est amené à l’âge adulte par une cérémonie ancienne. Qui accomplit les rites nécessaires à la transition ? |
| 6 | Quelle est la plus belle chose dans cette région ? | ou | Un jeune membre charismatique convainc de nombreuses personnes de l’aider dans un projet ambitieux. Quel est-il ? Qui rejoint ses efforts ? Lancez un projet pour le représenter. |
| 7 | Il y a une grande étendue d’eau sur la carte. Où est-elle ? À quoi ressemble-t-elle ? | ou | Où tout le monde dort-il ? Qui est mécontent de cet arrangement, et pourquoi ? |
| 8 | Comment le statut est-il acquis et défendu dans cette communauté ? Existe-t-il une hiérarchie claire parmi les membres de la communauté ici ? | ou | Au-delà des mots, comment les membres de la communauté communiquent-ils ici ? |
| 9 | L’un d’entre vous se remet encore de graves blessures infligées par les humains. Qui ? Quelle est la nature de ces blessures ? | ou | Deux des plus petits membres de la communauté se disputent. Qu’est-ce qui les a provoqués ? L’un des deux est-il gravement blessé ? |
| 10 | À quel point les régimes alimentaires varient-ils au sein de la communauté ? Quel personnage a le régime le plus inquiétant ou difficile à supporter ? | ou | Quels matériaux sont nécessaires pour entretenir et maintenir les repaires de la communauté ? Certains sont-ils difficiles à obtenir ? |
| 11 | Il est inhabituel que des être comme vous forment des communautés. Accordez-vous sur quelque chose expliquant pourquoi cette communauté existe. | ou | Il y a une immense structure artificielle sur la carte. Où est-elle ? Pourquoi est-elle abandonnée ? |
| 12 | Certains membres ont parcouru une grande distance pour rejoindre la communauté. Qu’est-ce qui les a attirés ici ? D’où sont-ils partis ? | ou | Où stockez-vous votre nourriture ? Pourquoi est-ce un endroit risqué pour entreposer des choses ? |
| 13 | Un rituel des occupants humains a été adopté par certains membres de la communauté ici. Quel est-il ? Accordez-vous sur quelque chose expliquant pourquoi ce rituel est vital à conserver et préserver comme le vôtre. | | |
...
| 5 | Des tentatives de finaliser un projet tournent à la dispute et à la colère. Retirez un projet de la carte. Ce projet a échoué. | ou | Un personnage est retrouvé mort à l’extérieur de la communauté. Personne n’a avoué le crime. Accordez-vous sur un responsable. |
| 6 | Un projet s’achève plus tôt que prévu. Expliquez comment cela a été résolu. Qui s’est montré le plus utile ? | ou | Un personnage charismatique exploite l’enthousiasme et la bonne volonté de la communauté. Lancez un nouveau projet. |
| 7 | Une ou un membre évoque des griefs datant d’avant l’occupation. Accordez-vous sur les anciens conflits de cette communauté. | ou | Un projet échoue. Lequel ? Pourquoi ? |
| 8 | En période de crise, un personnage charismatique révèle des ressources auparavant cachées. Quel problème cela résout-il ? | ou | Un personnage impopulaire est découvert en train de cacher des ressources à la communauté. Est-il puni ? |
| 9 | S’il n’y a aucun projet en cours, l’ennui mène à une dispute. Une bagarre éclate entre deux personnes. À quel sujet ? | ou | Quelqu’un disparaît dans des circonstances inquiétantes. Qui ? |
| 10 | Des conflits éclatent entre membres de la communauté, et un projet échoue en conséquence. | ou | Introduisez un mystère sombre parmi les membres de la communauté. Qui le découvre ? |
| 11 | Quelqu’un sabote un projet, et celui-ci échoue. Qui est-ce ? Est-il attrapé ? | ou | Quelqu’un est surpris en train de saboter les efforts de la communauté. Comment la communauté réagit-elle ? |
| 12 | Les journées d’été chaudes provoquent colère et paranoïa parmi les membres de la communauté. Les dirigeants réduisent les dissensions au silence (la semaine se termine immédiatement). | ou | La communauté entre dans une frénésie d’action (lancez un projet dangereux). |
| 13 | L’été est fugace. Défaussez les deux premières cartes du dessus du paquet et effectuez deux actions cette semaine. | | |
...
| 13 | Un ancien objet découvert sur la carte commence à attirer des étrangers en pèlerinage. Accordez-vous sur les problèmes causés par ces pèlerins. | | |
