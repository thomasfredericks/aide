...
- *creation*
  ...
  - *interactivite*
    ...
    - [continuum](/creation/interactivite/continuum/)
...
- *fabrication*
  - [arduino](/fabrication/arduino/)
    - [bounce2](/fabrication/arduino/bounce2/)
    - [chrono](/fabrication/arduino/chrono/)
    - [code](/fabrication/arduino/code/)
      - [millis](/fabrication/arduino/code/millis/)
        - [attendre](/fabrication/arduino/code/millis/attendre/)
        - [intervalle](/fabrication/arduino/code/millis/intervalle/)
        - *remplacer_delay*
          - [attendre](/fabrication/arduino/code/millis/remplacer_delay/attendre/)
    ...
    - [microosc](/fabrication/arduino/microosc/)
      - [envoi](/fabrication/arduino/microosc/envoi/)
      - [initialisation](/fabrication/arduino/microosc/initialisation/)
        - [SLIP](/fabrication/arduino/microosc/initialisation/SLIP/)
        - [UDP](/fabrication/arduino/microosc/initialisation/UDP/)
      - [reception](/fabrication/arduino/microosc/reception/)
...
- *logiciels*
  ...
  - [pd](/logiciels/pd/)
    - *audio*
      - [activation](/logiciels/pd/audio/activation/)
      - [fichiers](/logiciels/pd/audio/fichiers/)
    - *osc*
