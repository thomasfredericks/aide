...
> Le code actuel de la puce CH552T perd des paquets série lorsque des données sont envoyées vers l'Arduino en même temps que l'Arduino envoie des données.
> De plus, les connexions électriques de la puce CH552T causent aussi des interférences au niveau du Wi-Fi ce qui en réduit l'entendue.
> Plus d'informations :
